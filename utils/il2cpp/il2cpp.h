...
void Il2CppAttach()
{
    ...
    NSString *unityFrameworkPath = [appPath stringByAppendingPathComponent:NSENC("Frameworks/UnityFramework.framework/UnityFramework")]; // THIS NEED TO BE CHANGED IF Il2CPP ISN'T INIT IN "UnityFramework"
    ...
    IL2CPP::il2cpp_assembly_get_image = reinterpret_cast<const void *(*)(const void *)>(dlsym(handle, ENC("il2cpp_assembly_get_image")));
    IL2CPP::il2cpp_domain_get = reinterpret_cast<void *(*)()>(dlsym(handle, ENC("il2cpp_domain_get")));
    IL2CPP::il2cpp_domain_get_assemblies = reinterpret_cast<void **(*)(const void *, size_t *)>(dlsym(handle, ENC("il2cpp_domain_get_assemblies")));
    IL2CPP::il2cpp_image_get_name = reinterpret_cast<const char *(*)(void *)>(dlsym(handle, ENC("il2cpp_image_get_name")));
    IL2CPP::il2cpp_class_from_name = reinterpret_cast<void *(*)(const void *, const char *, const char *)>(dlsym(handle, ENC("il2cpp_class_from_name")));
    IL2CPP::il2cpp_class_get_method_from_name = reinterpret_cast<void *(*)(void *, const char *, int)>(dlsym(handle, ENC("il2cpp_class_get_method_from_name")));
    IL2CPP::il2cpp_class_get_field_from_name = reinterpret_cast<void *(*)(void *, const char *)>(dlsym(handle, ENC("il2cpp_class_get_field_from_name")));
    IL2CPP::il2cpp_field_get_offset = reinterpret_cast<size_t (*)(void *)>(dlsym(handle, ENC("il2cpp_field_get_offset")));
    IL2CPP::il2cpp_field_static_get_value = reinterpret_cast<void (*)(void *, void *)>(dlsym(handle, ENC("il2cpp_field_static_get_value")));
    IL2CPP::il2cpp_field_static_set_value = reinterpret_cast<void (*)(void *, void *)>(dlsym(handle, ENC("il2cpp_field_static_set_value")));

    // Additional IL2CPP function assignments
    IL2CPP::il2cpp_string_new = reinterpret_cast<monoString *(*)(const char *)>(dlsym(handle, ENC("il2cpp_string_new")));
    IL2CPP::il2cpp_string_new_utf16 = reinterpret_cast<void *(*)(const wchar_t *, int32_t)>(dlsym(handle, ENC("il2cpp_string_new_utf16")));
    IL2CPP::il2cpp_string_chars = reinterpret_cast<uint16_t *(*)(void *)>(dlsym(handle, ENC("il2cpp_string_chars")));
...
public:
    ...
    uint64_t getMethod(const char *methodName, int argsCount)
    {
        ...
        MemoryInfo info = getBaseAddress(ENC("UnityFramework"));
